...
public class Eu4ScriptStringLiteralImpl extends ASTWrapperPsiElement implements Eu4ScriptStringLiteral {

  public Eu4ScriptStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
