...
public class Eu4ScriptStatementImpl extends ASTWrapperPsiElement implements Eu4ScriptStatement {

  public Eu4ScriptStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Eu4ScriptAttribute getAttribute() {
    return findChildByClass(Eu4ScriptAttribute.class);
  }
