...
public class Eu4ScriptObjectImpl extends ASTWrapperPsiElement implements Eu4ScriptObject {

  public Eu4ScriptObjectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public Eu4ScriptProperty getProperty() {
    return findChildByClass(Eu4ScriptProperty.class);
  }
