...
public class Eu4ScriptNumberLiteralImpl extends ASTWrapperPsiElement implements Eu4ScriptNumberLiteral {

  public Eu4ScriptNumberLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
