...
public class Eu4ScriptExprImpl extends ASTWrapperPsiElement implements Eu4ScriptExpr {

  public Eu4ScriptExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Eu4ScriptLiteral getLiteral() {
    return findNotNullChildByClass(Eu4ScriptLiteral.class);
  }
