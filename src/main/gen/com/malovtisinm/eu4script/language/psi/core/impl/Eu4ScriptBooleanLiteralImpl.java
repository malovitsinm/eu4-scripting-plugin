...
public class Eu4ScriptBooleanLiteralImpl extends ASTWrapperPsiElement implements Eu4ScriptBooleanLiteral {

  public Eu4ScriptBooleanLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
